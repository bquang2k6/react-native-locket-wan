...
const Docs = () => {
    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: colors['base-100'] }]}>
            ...
            <View style={styles.content}>
                {/* Giới Thiệu */}
                <Text style={[styles.heading, { color: colors['base-content'] }]}>
                    1. Giới Thiệu Về Locket Wan
                </Text>
                <Text style={[styles.paragraph, { color: colors['base-content'] }]}>
                ...
                <View style={styles.list}>
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                        • Đăng nhập vào hệ thống với bảo mật nâng cao.
                    </Text>
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                        • Tải ảnh và video lên Locket.
                    </Text>
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                        • Tùy chỉnh caption theo ý thích.
                    </Text>
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                        • Chọn bạn bè có thể xem khi đăng.
                    </Text>
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                        • Forums chia sẻ màu caption.
                    </Text>
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                        • Quay video hoặc chụp ảnh trực tiếp trên web.
                    </Text>
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                        • Tùy chỉnh backend cho người dùng nâng cao.
                    </Text>
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                        • Tăng chất lượng ảnh/video <Text style={{ color: colors.secondary }}>(coming soon)</Text>.
                    </Text>
                </View>
                ...
                <View style={styles.list}>
                    ...
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                        ...
                        <Text style={{ color: colors.secondary }}>https://discord.gg/7JDAEp8Mgt</Text>
                    </Text>
                    <Text style={[styles.listItem, { color: colors['base-content'] }]}>
                ...
                <Text style={[styles.paragraph, styles.strikethrough, { color: colors['base-content'] }]}>
